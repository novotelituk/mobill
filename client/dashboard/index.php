	...
	<div class="row-fluid">
		 <div class="icons">
	      ...
	      <div class="span4" style="text-align: center;text-transform: uppercase;font-weight: bold;">
                 ...
                 <h3 style="font-weight: bolder;"><a href="receipt.php?id=<? echo $tr_link_id ?>">New Transaction</a></h3>
              </div>
              ...
              <div class="span4" style="text-align: center;text-transform: uppercase;font-weight: bold;">
                 <i class="icon-print" style="font-size: 120px;"></i>
                 <h3 style="font-weight: bolder;"><a href="newprod.php">Add Item</a></h3>
              </div>
              <div class="span4" style="text-align: center;text-transform: uppercase;font-weight: bold;">
        ...
        <div class="row-fluid" style="margin-top:20px;">
		 <div class="icons">
              <div class="span4" style="text-align: center;text-transform: uppercase;font-weight: bold; display: none;">
