...
<head>
  ...
  <link href="../../admin/common/theme/css/style-default.css?1372280973" rel="stylesheet" type="text/css" />
  
  
  <!-- LESS.js Library -->
  <script src="../../admin/common/theme/scripts/plugins/system/less.min.js"></script>
</head>
<body class="login ">
      ...
      <div class="widget widget-heading-simple widget-body-gray">
        ...
        <div class="widget-body">
          ...
          <form method="post" action="">
            ...
            <input type="text" name="email" class="input-block-level" placeholder="Your Username"/> 
...
<!-- // Themer END -->
  ...
  <!-- Code Beautify -->
  <script src="../../admin/common/theme/scripts/plugins/other/js-beautify/beautify.js"></script>
  <script src="../../admin/common/theme/scripts/plugins/other/js-beautify/beautify-html.js"></script>
  
  <!-- PrettyPhoto -->
  <script src="../../admin/common/theme/scripts/plugins/gallery/prettyphoto/js/jquery.prettyPhoto.js"></script>
  ...
  <!-- Modernizr -->
  <script src="../../admin/common/theme/scripts/plugins/system/modernizr.js"></script>
  
  <!-- Bootstrap -->
  <script src="../common/bootstrap/js/bootstrap.min.js"></script>
  
  <!-- SlimScroll Plugin -->
  <script src="../../admin/common/theme/scripts/plugins/other/jquery-slimScroll/jquery.slimscroll.min.js"></script>
  
  <!-- Common Demo Script -->
  <script src="../../admin/common/theme/scripts/demo/common.js?1372280973"></script>
  
  <!-- Holder Plugin -->
  <script src="../../admin/common/theme/scripts/plugins/other/holder/holder.js"></script>
  <script>
  ...
  <script src="../../admin/common/theme/scripts/plugins/forms/pixelmatrix-uniform/jquery.uniform.min.js"></script>
